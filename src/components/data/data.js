const projects = [
	{
		id: 1,
		imgsrc: "./images/pb6.jpg",
		cardhead: "Punjab Flood Relief Operations",
		description:
			"Life Foundation, an NGO dedicated to humanitarian service, extended crucial support during the recent floods in Punjab. The disaster left thousands of families displaced and struggling for survival. To aid the affected communities, Life Foundation organized medical camps, ensuring timely healthcare for flood-hit families. In addition, dry rations and basic necessities such as rice, flour, pulses, and essential supplies were distributed to provide immediate relief. The initiative focused on reaching vulnerable families who lost access to food and healthcare, aiming to restore stability and dignity in their lives. Through its dedicated volunteers and relief workers, Life Foundation continues to stand with the people of Punjab in rebuilding their lives after this calamity. For further details about the Foundation’s flood relief programs and how to contribute, please contact them directly or visit their website.",
	},
	{
		id: 2,
